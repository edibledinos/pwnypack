...
if __name__ == '__main__':
    ...
    versions = sorted(six.iteritems(version_info), key=lambda i: i[0])
...
''')
    ...
    for version, info in versions:
        ...
        print('''#: This dictionary describes the internals of CPython {major}.{minor}.{micro}.
PY_{version} = {{
    'version': {version},
    'magic': {info[magic]},
